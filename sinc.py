...
if __name__ == '__main__':
    ...
    r = requests.get('http://45.55.248.209:5001/pedidos/')
    jsonResponse = r.json()
    ...
    if jsonResponse["isError"] == False:
        ...
        for campoValor in jsonResponse["result"]:
            if currPedido != campoValor["idPedido"]:
                if currPedido != -1:
                    ...
                    cerrarPedido="http://45.55.248.209:5001/pedidos/{0}".format(campoValor["idPedido"])
        ...
        if currPedido != -1:
            #Cerrar el pedido!
            print("Cerrar el pedido* {0}".format(currPedido))
            cerrarPedido2="http://45.55.248.209:5001/pedidos/{0}".format(campoValor["idPedido"])
